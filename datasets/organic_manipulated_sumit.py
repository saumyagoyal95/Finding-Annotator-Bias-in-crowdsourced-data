...
class OrganicDataset_manipulated_sumit(BaseDataset):
    def __init__(self, **args):
        ...
        data1=self.data[(self.data['annotator']=='sumit') & (self.data['label']==1)]
        data2=self.data[(self.data['annotator']!='sumit') | (self.data['label']!=1)]
        data1.label=2
        self.data=data1.append(data2)
        print(self.data.loc[(self.data['annotator']=='sumit') & (self.data['label']==1)])
